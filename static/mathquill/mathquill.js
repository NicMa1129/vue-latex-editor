...
// LatexCmds.backepsilon = LatexCmds.contains = bind(BinaryOperator,'\\backepsilon ','&ni;');
...
LatexCmds.divideontimes = bind(VanillaSymbol, '\\divideontimes ', '&#8230;');
//Misc
...
LatexCmds.bigcap = bind(VanillaSymbol, '\\cap ', '&#8745;');
LatexCmds.bigcup = bind(VanillaSymbol, '\\cup ', '&#8746;');
...
LatexCmds.overarc = bind(Style, '\\widehat ', 'span', 'class="mq-non-leaf mq-overarc"');
...
var Class = LatexCmds['class'] = P(MathCommand, function(_, super_) {
  ...
  _.latex = function() {
    console.log('this.blocks[0].latex()',this.blocks[0].latex())
...
LatexCmds['\u2211'] =
LatexCmds.sum =
LatexCmds.summation = bind(SummationNotation,'\\sum\\limits ','&sum;');

LatexCmds['\u220f'] =
LatexCmds.prod =
LatexCmds.product = bind(SummationNotation,'\\prod\\limits ','&prod;');
...
Environments.matrix = P(Matrix, function(_, super_) {
  ...
  _.latex = function() {
    ...
    latex += '';
    return '\\left \\{' + this.wrappers().join(latex) + '\\right.';
  };
});
